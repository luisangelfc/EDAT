// Alineación, entrevistas y selección del Hiring Manager. Los candidatos se consultan a través de EDAT.
...
// Ejecuta la acción y muestra el resultado.
...
function hmRenderAccionesShortlist() {
    ...
    acciones.innerHTML = `
        <button
            ...
            ${listo ? "" : "disabled"}
        >
            Agendar ${HM_MAX_SELECCION} candidatos seleccionados a entrevista con Hiring Manager
        </button>
    `;
